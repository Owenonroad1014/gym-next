...
(6, '張營芳', 'user6@example.com', NULL, 'fc4c0d35e3f7d6292f24a95f896f1eae2fdc46cf4a5a8246d4b79b0ee0a5b8c4', '2025-03-16 17:43:45', '2025-03-16 17:43:45'),
(7, '黃嚴婷', 'user7@example.com', NULL, 'e99a18c428cb38d5f260853678922e03abd8d62b8e18f27f6fc2c17d14e6f0ef', '2025-03-16 17:43:45', '2025-03-16 17:43:45'),
(8, '趙禮志', 'user8@example.com', NULL, '7a57a5a743894a0e72e525d9ff363b60f7285a6e78bd030ccd54816b7b7a1327', '2025-03-16 17:43:45', '2025-03-16 17:43:45'),
(9, '許新麗', 'user9@example.com', NULL, 'b89eaac7e61417341b710b727768294d0e6a277b3f3af21c5f6ac1c0f2f66c92', '2025-03-16 17:43:45', '2025-03-16 17:43:45'),
(10, '周成宏', 'user10@example.com', NULL, '0a7d2c61a8d0745126657a4b7c3d4f305ea3c7f19c3d3e9df99954ef797b6e02', '2025-03-16 17:43:45', '2025-03-16 17:43:45');
...
(1, 'P001', '啞鈴', '專業級鑄鐵啞鈴，採用優質鋼材製造，表面經特殊處理防滑耐用。適合初學者到專業健身愛好者使用，可進行多種訓練動作如二頭肌捲舉、三頭肌訓練、肩部推舉等。把手設計符合人體工學，確保舒適穩固的抓握感。每天租金50元，是建立基礎肌力的理想選擇。', 1, 50, 'dumbbel.jpg', 3.33, '2025-03-13 07:37:00'),
...
(7, 'P007', '可調式健身椅', '多功能專業健身椅，採用高強度鋼架結構，承重力強。座椅角度可多段調節，適應不同訓練需求。加厚高密度海綿墊，提供舒適支撐。適合進行啞鈴訓練、臥推等多種重訓動作，是打造完整居家健身房的核心裝備。折疊設計節省空間，方便收納。', 1, 100, 'bench.jpg', 5.00, '2025-03-13 07:37:00'),
...
(9, 'P009', '槓片', '專業橡膠包覆槓片，採用優質鑄鐵內芯，確保重量準確。特殊橡膠材質能有效降低運動噪音，保護地板。人性化把手設計方便搬運，多種重量可選擇。適合搭配槓鈴、深蹲架等器材使用，可進行多樣化的重量訓練。', 1, 50, 'fitness-weight.jpg', 4.00, '2025-03-13 07:37:00'),
...
(11, 'P031', '瑜珈墊', '採用環保TPE材質，具備優異防滑與緩衝效果。加厚設計(6mm)提供舒適支撐，減輕關節壓力。特殊材質易於清潔維護，無異味。輕量化設計便於攜帶，附贈收納繩。適合瑜珈、皮拉提斯等多種健身活動使用。', 2, 20, 'yoga-mat.jpg', 1.00, '2025-03-13 07:37:00'),
...
(13, 'P033', '瑜珈輪', '專業級瑜珈輔具，採用環保TPE材質製造，堅固耐用且安全無毒。特殊圓環設計完美支撐背部，幫助改善姿勢與增加柔軟度。內徑尺寸經過精心設計，適合各種體型的使用者。表面防滑顆粒處理，確保運動過程中的穩定性。適合瑜珈、普拉提等課程使用，是提升背部柔軟度與核心力量的理想工具。', 2, 50, 'yoga-wheel.jpg', 3.00, '2025-03-13 07:37:00'),
(14, 'P034', '瑜珈繩', '採用優質棉質材料編織，柔軟耐用不刺激皮膚。D型金屬扣環設計，方便調整長度以適應不同體型需求。特製加寬設計減輕局部壓力，提供舒適的握持感。適合進行深層伸展訓練，幫助提升柔軟度，尤其適合肩部、腿部等部位的伸展。可搭配瑜珈、舞蹈等運動課程使用，是提升身體靈活度的完美輔具。', 2, 50, 'yoga-strap.jpg', 5.00, '2025-03-13 07:37:00'),
(15, 'P035', '瑜珈球', '採用高密度PVC材質，防爆耐壓設計確保運動安全。表面特殊壓紋處理，提供極佳防滑效果。可承重300公斤，穩定性極佳。適合進行核心訓練、平衡訓練，或作為辦公座椅使用。多種尺寸可選，適合不同身高體型的使用者。附贈充氣泵，方便調節球體硬度，是提升平衡感與核心力量的理想選擇。', 2, 50, 'yoga-ball.jpg', 4.00, '2025-03-13 07:37:00'),
...
(18, 'P053', '護齒', '醫療級矽膠製成，柔軟舒適且安全無毒。可熱塑設計，能依據個人牙齒形狀進行調整，提供完美貼合度。特殊氣道設計，確保運動時呼吸順暢。附專用收納盒，方便攜帶與衛生保存。適合各種對抗性運動使用，有效預防運動傷害，保護牙齒與口腔。', 3, 50, 'Boxing-Mouthguard.jpg', 4.00, '2025-03-13 07:37:00'),
